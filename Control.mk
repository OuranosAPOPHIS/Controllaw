...
## 
## Makefile     : Control.mk
## Generated on : Fri Feb 17 15:14:24 2017
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/klinec2/Desktop
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
INCLUDES_BUILDINFO = -I$(START_DIR)/Control_grt_rtw -I$(START_DIR) -IP:/SPRING~1/AE445~1 -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=Control -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/Control_grt_rtw/Control.c $(START_DIR)/Control_grt_rtw/Control_data.c $(START_DIR)/Control_grt_rtw/rtGetInf.c $(START_DIR)/Control_grt_rtw/rtGetNaN.c $(START_DIR)/Control_grt_rtw/rt_nonfinite.c rt_logging.c
...
OBJS = Control.obj Control_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_logging.obj
...
%.obj : $(START_DIR)/Control_grt_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
